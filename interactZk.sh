...
#For this to run you need docker installed and running!!!
...
# Compile and deploy RewardToken contract
echo "Creating zkSync local node..."
#For this to run you need docker installed and running!!!
npx zksync-cli dev start
echo "Deploying token contract..."
TOKEN_ADDRESS=$(forge create src/RewardToken.sol:RewardToken --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync | awk '/Deployed to:/ {print $3}' )
